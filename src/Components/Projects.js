            ...
            <div className="project  ">
                <div className='d-flex flex-wrap justify-content-evenly '>
                    <div className="  project-list">
                        <img className=" project-image" alt="netflix-project" src="image/Netflix.png" />
                    ...
                    <div className=" project-list">
                        <img alt='angry birds project' className=" project-image" src="image/Angry-Bird-UI.png" />
                        <div className='d-flex justify-content-between m-2 project-title'>
                            <div>
                    ...
                    <div className="project-list">
                        <img alt='project-three' className=" project-image" src="image/iam.png" />
                        <div className='d-flex justify-content-between m-2 project-title'>
                            <div>
                                <h6>Project Name</h6>
