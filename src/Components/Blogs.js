        ...
        <div className="row container-fluid bg-success p-3">
            ...
            <div className=" col-xl-3 col-sm-12 col-md-6 ">
                ...
                <Link to='/Components/Blogs/Reactblog' className="text-black text-decoration-none">
                    <img className="img-fluid blogs-image" alt="react images" src="https://img.freepik.com/free-vector/creative-abstract-quantum-illustration_23-2149226910.jpg?w=996&t=st=1707822244~exp=1707822844~hmac=bb4650dbcd9a2bd5964b675542b4540717b8e2d4ef0f4a76c32abdb74c818106" />
                    <p className="ms-2 mt-2">Author : Satyashil Magre</p>
            ...
            <div className=" col-xl-3 col-sm-12 col-md-6">
              ...
              <Link to='/Components/Blogs/html' className="text-black text-decoration-none">
                <img className="img-fluid blogs-image" alt="html and css images" src="https://img.freepik.com/free-vector/hand-drawn-web-developers_23-2148819604.jpg?w=996&t=st=1707822545~exp=1707823145~hmac=bda84bc523aa706ced87cdcaeef4993bc434d9a918de622a14bb1a33a8557e7d" />
                <p className="ms-2 mt-2">Author : Satyashil Magre</p>
          ...
          <Link to='/Components/Blogs/angular' className="text-black text-decoration-none">
                <img className="img-fluid blogs-image" alt="Angular images" src="https://img.freepik.com/free-vector/javascript-frameworks-concept-illustration_114360-743.jpg?w=996&t=st=1707822715~exp=1707823315~hmac=16efe4ac966d021e2057e15d8e09e298bc4b167ff7980b4853cffef2d07c1316" />
                <p className="ms-2 mt-2">Author : Satyashil Magre</p>
